package com.lowcoupling.mdpm.ui.ganttview.views;
...
import com.lowcoupling.mdpm.ui.ganttview.Activator;

public class GanttView extends ViewPart implements ISelectionListener{

	public static final String ID = "com.lowcoupling.mdpm.lng.plan.ganttview.views.GanttView";
